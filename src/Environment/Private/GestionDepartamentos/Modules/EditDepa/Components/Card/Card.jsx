...
import { BorrarDepa } from '../../../DeleteDepa';
import { Alert } from '../../../../../../../Components/Alerts/Alerts';
import { Loading } from '../../../../../../../Components/Loading';
import { Select } from '../../../NewDepa/Components/Select';
...
export default function MediaControlCard({IdEditGestion,setIdEditGestion,renderizarLista}) {
    ...
    const guardarItem=()=>{
        ...
        if(Numero!='' && IdAla!=''){
            ...
            axios.post('http://localhost:3000/Api/Departamento-Edit', {
                Numero:Numero,
                Id:Id,
                IdTorre:IdAla
            })
    ...
    const queryEffect=async(id)=>{
        ...
        .then(function (response) {
            ...
            setNumero(response.data.data[0].depa_numero)
            setId(response.data.data[0].depa_id)
            setIdAla(response.data.data[0].torre_id)
                ...
                <Grid container spacing={0} style={{backgroundColor:''}}>
                    ...
                    <Grid item xs={10}>
                        <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                            <Grid container spacing={2}>
                                ...
                                <Grid item xs={6}>
                                    <TextField id="outlined-basic" label="# Depa" variant="outlined" onChange={e=>{setNumero(e.target.value)}} value={Numero}/>
                                </Grid>
                    ...
                    <Grid container spacing={0} style={{backgroundColor:'',paddingLeft:'20px'}}>
                        ...
                        <Grid item xs={2} style={{backgroundColor:''}}>
                            ...
                            <div style={{display:'flex',justifyContent:'end',alignItems:'center'}}>
                                <BorrarDepa Id={Id} setIdEditGestion={setIdEditGestion} renderizarLista={renderizarLista}/>
